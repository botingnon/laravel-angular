...
var AppComponent = /** @class */ (function () {
    function AppComponent(dialog, postSercice) {
        this.dialog = dialog;
    ...
    AppComponent.prototype.openDialog = function () {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.postSercice.salvar(result.post, result.arquivo);
            }
        });
    };
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.like = function (id) {
        ...
        this.http.get("/api/like/" + id)
            .subscribe(function (event) {
            var post = _this.posts.find(function (p) { return p.id === id; });
            if (post) {
...
var PostComponent = /** @class */ (function () {
    function PostComponent(postSercice) {
        this.postSercice = postSercice;
    }
